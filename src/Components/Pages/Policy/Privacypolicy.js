    ...
    <div className='Privacy_Policy'>
      ...
      <img src={logo} alt='' />
        ...
        <div className='Privacy_item'>
          <p>
            This privacy notice for Productive Alliance LLC ("Company," "we," "us," or "our"), describes how
            and why we might collect, store, use, and/or share ("process") your information when you use
            our services ("Services"), such as when you:
          </p>
          <ul>
            <li>
              <ol>
                <li>Visit our website at http://www.productivealliance.com, or any website of ours that links
            ...
            <li>
              <ol>
                <li>
                  Download and use our mobile application (Productive Alliance ), or any other application
            ...
            <li>
              <ol>
                <li>
                  Engage with us in other related ways, including any sales, marketing, or events Questions
                  or concerns? Reading this privacy notice will help you understand your privacy rights and
        ...
        <div className='Privacy_content'>
          ...
          <p>This summary provides key points from our privacy notice, but you can find out more
            ...
            our table of contents below to find the section you are looking for. You can also click
            here to go directly to our table of contents.</p>

          <p>
            What personal information do we process? When you visit, use, or navigate our Services,
            we may process personal information depending on how you interact with Productive Alliance
            LLC and the Services, the choices you make, and the products and features you use. Click here
            to learn more.
          </p>
          <p>
            Do we process any sensitive personal information? We may process sensitive personal
            information when necessary with your consent or as otherwise permitted by applicable law. Click
            here to learn more.
          </p>
          <p>
            Do we receive any information from third parties? We may receive information from public
            databases, marketing partners, social media platforms, and other outside sources. Click here to
            learn more.
          </p>
          <p>
            ...
            process your information only when we have a valid legal reason to do so. Click here to learn
            more.
          </p>
          <p>
            In what situations and with which parties do we share personal information? We may
            share information in specific situations and with specific third parties. Click here to learn more.
          ...
          <p>What are your rights? Depending on where you are located geographically, the applicable
            privacy law may mean you have certain rights regarding your personal information. Click here to
            learn more.</p>
          <p>How do you exercise your rights? The easiest way to exercise your rights is by filling out our
            data subject request form available here: http://www.productivealliance.com, or by contacting
            us. We will consider and act upon any request in accordance with applicable data protection
            laws.</p>
          <p>Want to learn more about what Productive Alliance LLC does with any information we collect?
        ...
        <div className='Privacy_item'>
          ...
          <p>Sensitive Information. When necessary, with your consent or as otherwise permitted by
            applicable law, we process the following categories of sensitive information: ● health
            data</p>
          <ul>
            <li>
              <li> financial data
        ...
        <div className='Privacy_item'>
          <p><strong>Payment Data.</strong> We may collect data necessary to process your payment if you make
            ...
            security code associated with your payment instrument. All payment data is stored by To be
            determined . You may find their privacy notice link(s) here: http://www.productivealliance.com.
          </p>
          <p><strong>Social Media Login Data. </strong> We may collect data necessary to process your payment if you make
          ...
          <p><strong>Application Data. </strong> We may collect data necessary to process your payment if you make
          ...
          <ul>
            <li>
              ...
              <li><strong> Mobile Device Access.</strong>s. We may request access or permission to certain features from
                your mobile device, including your mobile device's calendar, camera, bluetooth, contacts,
                sms messages, social media accounts, storage, and other features. If you wish to
                change our access or permissions, you may do so in your device's settings.

              </li>
              <li><strong> Mobile Device Data. </strong>We automatically collect device information (such as your mobile
              ...
              <li><strong>Push Notifications.</strong>We may request to send you push notifications regarding your
          ...
          <ul>
            <li>
              <li><strong> Log and Usage Data</strong>a. Log and usage data is service-related, diagnostic, usage, and
          ...
          <li><strong>In Short: </strong>We collect location data such as information about your device's location,
        ...
        <div className='Privacy_content'>
          ...
          <p><strong>Information collected from other sources2. HOW DO WE PROCESS YOUR INFORMATION?</strong></p>
          ...
          <ul>
            <li>
              <li>To facilitate account creation and authentication and otherwise manage user accounts.
                We may process your information so you can create and log in to your account, as welas keep your account in working order.
              </li>
              ...
              <li>
                To determine the effectiveness of our marketing and promotional campaigns. We may
                process your information to better understand how to provide marketing and promotional
                campaigns that are most relevant to you.To comply with our legal obligations. We may process your information to comply with
        ...
        <div className='Privacy_content'>
          ...
          <ul>
            <li>
              <li>Business Transfers. We may share or transfer your information in connection with, or
                during negotiations of, any merger, sale of company assets, financing, or acquisition of
                all or a portion of our business to another company.

              </li>
              <li>When we use Google Maps Platform APIs. We may share your information with certain
                Google Maps Platform APIs (e.g., Google Maps API, Places API). To find out more
                about Google’s Privacy Policy, please refer to this link. We obtain and store on your
                device ("cache") your location. You may revoke your consent anytime by contacting us
                at the contact details provided at the end of this document.

              </li>
              <li>Business Partners. We may share your information with our business partners to offer
                you certain products, services, or promotions.

              </li>
              <li>
                Offer Wall. Our application(s) may display a third-party hosted "offer wall." Such an offer
                wall allows third-party advertisers to offer virtual currency, gifts, or other items to users in
                return for the acceptance and completion of an advertisement offer. Such an offer wall
                may appear in our application(s) and be displayed to you based on certain data, such as
                your geographic area or demographic information. When you click on an offer wall, you
                will be brought to an external website belonging to other persons and will leave our
                application(s). A unique identifier, such as your user ID, will be shared with the offer wall
                provider in order to prevent fraud and properly credit your account with the relevant
                reward.
              </li>
        ...
        <div className='Privacy_content'>
          ...
          <p>The Services, including our offer wall, may link to third-party websites, online services, or mobile
            applications and/or contain advertisements from third parties that are not affiliated with us and
            which may link to other websites, services, or applications. Accordingly, we do not make any
            guarantee regarding any such third parties, and we will not be liable for any loss or damage
            caused by the use of such third-party websites, services, or applications. The inclusion of a link
            towards a third-party website, service, or application does not imply an endorsement by us. We
            cannot guarantee the safety and privacy of data you provide to any third parties. Any data
            collected by third parties is not covered by this privacy notice. We are not responsible for the
            content or privacy and security practices and policies of any third parties, including other
            websites, services, or applications that may be linked to or from the Services. You should review
        ...
        <div className='Privacy_content'>
          ...
          <p><strong>6.HOW DO WE HANDLE YOUR SOCIAL LOGINS?7.HOW LONG DO WE KEEP YOUR INFORMATION?</strong></p>
          <p><strong>In Short:</strong>
        ...
        <div className='Privacy_content'>
          ...
          <p>
            ...
            us at eugene@productivealliance.com.
          </p>
        ...
        <div className='Privacy_content'>
          ...
          <p><strong>Withdrawing your consent:</strong>
            If we are relying on your consent to process your persona
          ...
          <p><strong>Opting out of marketing and promotional communications: </strong>You can unsubscribe from our
            ...
            the emails that we send, replying "STOP" or "UNSUBSCRIBE" to the SMS messages that we
            send, or by contacting us using the details provided in the section "HOW CAN YOU CONTACT
            US ABOUT THIS NOTICE?" below. You will then be removed from the marketing lists. However,
            we may still communicate with you — for example, to send you service-related messages that
            are necessary for the administration and use of your account, to respond to service requests, or
          ...
          <p><strong>Cookies and similar technologies: </strong>Most Web browsers are set to accept cookies by default. If you prefer, you can usually choose
            to set your browser to remove cookies and to reject cookies. If you choose to remove cookies or
            reject cookies, this could affect certain features or services of our Services. To opt out of
            ...
            at eugene@productivealliance.com.
          </p>
        </div>
        ...
        <div className='Privacy_content'>
          ...
          <p>
            You may contact us by email at eugene@productivealliance.com, or by referring to the contact
        ...
        <div className='Privacy_content'>
          ...
          <p>Productive Alliance LLC has not disclosed or sold any personal information to third parties for a
            business or commercial purpose in the preceding twelve (12) months. Productive Alliance LLC
            will not sell personal information in the future belonging to website visitors, users, and other
            consumers.
          </p>
        ...
        <div className='Privacy_content'>
          ...
          <p>Upon receiving your request, we will need to verify your identity to determine you are the same
            ...
            other verification methods as the circumstances dictate.</p>
          ...
          <p>We will only use personal information provided in your request to verify your identity or authority
            ...
            information already maintained by us, we may request that you provide additional information
            for the purposes of verifying your identity and for security or fraud-prevention purposes. We will
          ...
          <p>Other privacy rights
            ...
            To exercise these rights, you can contact us by email at eugene@productivealliance.com, or by
        ...
        <div className='Privacy_content'>
          ...
          <p>If you have questions or comments about this notice, you may email us
            at eugene@productivealliance.com or by post to:
          </p>
          <p>
            <p>Productive Alliance LLC</p>
            <p>1 Shea Lane</p>
            <p>Tinton Falls , NJ 07724</p>
            <p>United States</p>
        ...
        <div className='Privacy_content'>
          ...
          <p>
            http://www.productivealliance.com/
          </p>
