        ...
        <div className="row">
          ...
          <div className="col-sm-8">
            ...
            <ul id="progressPills" className="pills">
              <li onclick="wiz_nav('sec_wiz_1')" id="prP_1" hold>
              </li>
              <li onclick="wiz_nav('sec_wiz_2')" id="prP_2">
              </li>
              <li onclick="wiz_nav('sec_wiz_3')" id="prP_3">
              </li>
              <li onclick="wiz_nav('sec_wiz_4')" id="prP_4">
              </li>
            </ul>
            ...
            <div id="section_group" className="section_group">
              <div id="sec_wiz_1" className="section" active="">
                ...
                <ul id="" className="gender_holder float_wrapper">
                  <li onclick="wiz_nav('sec_wiz_2')" className="item">
              ...
              <div id="sec_wiz_2" className="section">
                ...
                <button onclick="wiz_nav('sec_wiz_3')" className="lazy button" type="button" name="button">next</button>
              </div>
                    ...
                    <div className="row">
                      <div className="col-sm-12">
                        <div className="input_group" style={{textAlign:'center'}}>
                          <label for="" className="static">date of delivery</label>
