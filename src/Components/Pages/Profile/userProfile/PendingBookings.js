// src/components/PendingBookings.js

import React from 'react';
import { FallingLines } from 'react-loader-spinner';
import { IP } from '../../../../Constant';

const PendingBookings = ({ pendingAppointments, isLoading, handleToggle, isEventOpen }) => {
  return (
    <div className="row mt-3" id="overview_page_container">
      ...
      {isLoading ? (
        ...
        pendingAppointments.map((post, index) => (
                  ...
                  <div className="more_detail">
                    ...
                    <div className="host">
                      ...
                      {post.service_status === 'pending' ? (
                        ...
                        <p>Appointment with <b>{post.host}</b></p>
                      )}
                    </div>
