                    ...
                    <div className="row">
                        <div className="col-sm-5">
                            <div className="heading">
                                ...
                                <Link to="https://play.google.com/store/apps" target="_blank"><img style={{ maxWidth: "180px" }} src={Image1} alt="" /></Link>
                                <Link to="https://play.google.com/store/apps" target="_blank"><img style={{ maxWidth: "161px" }} src={Image2} alt="" /></Link>
                            </div>
                        </div>
                        <div className="col-sm-7">
                            <div className="gutter" style={{paddingLeft:"50px"}}>
