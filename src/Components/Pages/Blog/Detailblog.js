...
function Blog() {
  ...
  //   nav(`/blogpage?year=${year}&month=${selectedMonth}`);
  ...
  const handleMonthClick = (year, month) => {
    ...
    nav(`/blogpage/year=${year}&month=${month < 10 ? `0${month}` : `${month}`}`);
    // Use the selectedYear and selectedMonth values as needed
  };
              ...
              <div className="blog_wrapper">
                <div className="blogContent">
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage: `url(${`${IP}/file/${users.attachments}`})`,
                      borderRadius: '7px',
                    }}
                  ></div>
              ...
              {Recent.map((post, index) => (
                <div key={index} className='sideBox row' onClick={() => setId(post._id)}>
                  ...
                  <div className='sideImg col-sm-3'>
                    ...
                    <img src={`${IP}/file/${post.attachments}`} alt={`Sample ${index + 1}`} />
                  </div>
