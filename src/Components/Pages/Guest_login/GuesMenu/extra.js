...
//                 amount: 1000, // Assuming the amount is in cents (i.e., $10.00)
//                 returnUrl: 'http://localhost:3000//userProfile/payment/success/:paymentId'
//             });
//             setPaymentIntentId(response?.data?.paymentIntent?.id);
//             setClientSecret(response.data.client_secret)
//             console.log("data of paymemnt", response?.data?.paymentIntent?.id)
//             console.log("data of paymemnt", response?.data?.paymentIntent?.client_secret)
//         } catch (error) {
//             console.error('Error creating payment intent:', error);
//         }
//     };
...
//         try {
//             const response = await axios.post('http://localhost:5000/api/confirm-and-capture-payment', {
//                 paymentIntentId: paymentIntentId
//             });
...
//             {paymentIntentId && (
//                 <button onClick={confirmAndCapturePayment}>Confirm and Capture Payment</button>
//             )}
//         </div>
//     );
// };
