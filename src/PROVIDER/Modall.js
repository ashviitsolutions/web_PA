...
// function CustomModal({ title, location, time, onClose, show }) {
//   useEffect(() => {
//     if (show) {
//       // Set show to true when the component mounts or based on some condition
//       // For example, you can perform actions when the modal becomes visible
//     }
//   }, [show]);

//   const handleClose = () => {
//     // Handle any additional logic when the modal is closed
//     onClose();
//   };
